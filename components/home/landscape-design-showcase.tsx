...
import { landscapeFeatures } from "@/data/landscape"

export default function LandscapeDesignShowcase() {
      ...
      <div className="container">
        <FadeIn direction="up">
          <div className="flex flex-col items-center text-center mb-12">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">Landscape Excellence</h2>
            <p className="mt-4 max-w-3xl text-muted-foreground">
              Experience the harmony between architecture and nature in our thoughtfully designed outdoor spaces
            </p>
          </div>
        </FadeIn>
          ...
          <FadeIn direction="right">
            <div className="overflow-hidden dark:bg-[#0B0B0F] bg-white w-full rounded-xl shadow-lg">
              <MacbookScroll
                title={
                  <span>
                    {landscapeFeatures[activeFeature].title} <br />
                    <span className="text-lg font-normal">{landscapeFeatures[activeFeature].description}</span>
                  </span>
                }
                src={landscapeFeatures[activeFeature].image}
                showGradient={false}
              />
            </div>
          </FadeIn>
